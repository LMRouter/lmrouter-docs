...
Please refer to the [OpenAI image editing endpoint](https://platform.openai.com/docs/api-reference/images/createEdit) for more information on how to use the image editing endpoint.
